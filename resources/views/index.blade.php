      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-6 pt-5 pt-lg-0">
            <h3 data-aos="fade-up">What is liveIn?</h3>
            <p data-aos="fade-up" data-aos-delay="100">
              LiveIn is an information website that aims to disseminate information regarding live streaming schedules, seminars, workshops, training, and others. With LiveIn you can invite more people to your event or find great events for you.
            </p>
            <div class="row">
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-receipt"></i>
                <h4>Organize your event</h4>
                <!-- <p>Consequuntur sunt aut quasi enim aliquam quae harum pariatur laboris nisi ut aliquip</p> -->
              </div>
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <i class="bx bx-cube-alt"></i>
                <h4>find great events for you</h4>
