          ...
          <div class="col-lg-6 pt-5 pt-lg-0">
            ...
            <div class="row">
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <h4>Kenapa harus menggunakan LiveIn?</h4>
                <p>Karena dengan menggunakan LiveIn, event yang kita buat jadi semakin ramai pengunjung atau pengikutnya.</p>
              </div>
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <i class="bx bx-cube-alt"></i>
                <h4>Bagaimana LiveIn terbentuk?</h4>
                <p>LiveIn terbentuk karena adanya ide dari kelompok kami, yang dimana juga ini merupakan final project dari tugas kami yang diberikan bapak ibu dosen.</p>
              </div>
            </div>
          </div>
        </div>
