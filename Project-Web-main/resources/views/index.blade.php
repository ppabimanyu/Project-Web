          ...
          <div class="col-lg-6 pt-5 pt-lg-0">
            ...
            <div class="row">
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <h4>Berdirinya LiveIn</h4>
                <p>LiveIn dibuat pada tahun 2021 oleh beberapa mahasiswa dan mahasiswi Politeknik Negeri Jember.</p>
              </div>
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <i class="bx bx-cube-alt"></i>
                <h4>Visi Misi LiveIn</h4>
                <p>Visi Misi LiveIn adalah untuk mempermudah pengguna dan penikmat live streaming dengan mengetauhi jadwal melalui LiveIn</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-orange">
          ...
          <div class="container pt-5">
            ...
            <form action="{{ url('/search') }}" method="post">
              @csrf
              <div class="mb-5 d-flex bg-white rounded-pill border border-2">
        ...
        <div class="row">
          ...
          <div class="col" data-aos="zoom-in" data-aos-delay="400">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Muhammad Ryan Januriansyah </h4>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <p>Follow us on other social media for the latest news.</p>
