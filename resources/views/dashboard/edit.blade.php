            ...
            <div class="col-md-6">
                <form action="{{url('/update/'.$event->id)}}" method="post" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <select id="inputState" class="form-select @error('category') is-invalid @enderror" name="category" value="{{ $event->category}}">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control @error('platform') is-invalid @enderror" id="platform" name="platform" value="{{ $event->platform}}">
                        @error('platform')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('link') is-invalid @enderror" id="link" name="link" value="{{ $event->link}}">
                        </div>
                        @error('link')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="editor" class="form-control @error('description') is-invalid @enderror" id="description" rows="6" name="description">{{ $event->description}}</textarea>
                        @error('description')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
