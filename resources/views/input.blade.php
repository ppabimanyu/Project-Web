        ...
        <div class="container mx-auto md:p-6 p-4 bg-white shadow sm:rounded-2xl">               
            <div class="md:grid md:grid-cols-6 md:gap-4 px-8">
                <div class="mt-5 md:mt-0 md:col-span-3">
                    <form action="/dashboard" method="post" class="sm:overflow-hidden">
                    @csrf
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="title" class="block text-md font-medium text-gray-700">Title</label>
                                <input type="text" id="title" name="title" autocomplete="title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-md rounded-md border-gray-300 @error('title') border-red-500 @enderror" placeholder="Title">
                                @error('title')
                            ...
                            <div class="col-span-3 sm:col-span-1">
                                ...
                                <input type="time" id="time" name="time" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-md border-gray-300 rounded-md @error('time') border-red-500 @enderror" placeholder="h:mm PM/AM">
                                @error('time')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-span-3 sm:col-span-2">
                                ...
                                <input type="date" data-date-format="YYYY MMMM DD" id="date" name="date" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-md border-gray-300 rounded-md @error('date') border-red-500 @enderror" placeholder="yyyy-mm-dd">
                                @error('date')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-span-6 sm:col-span-1">
                                ...
                                <input type="text" id="platform" autocomplete="given-name" name="platform" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-md border-gray-300 rounded-md @error('platform') border-red-500 @enderror" placeholder="Zoom">
                                @error('platform')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="text" id="link" name="link" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-md border-gray-300 @error('link') border-red-500 @enderror" placeholder="www.example.com">
                                </div>
                                @error('link')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="about" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-md border border-gray-300 rounded-md @error('description') border-red-500 @enderror" placeholder="Description"></textarea>
                                </div>
                                @error('description')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
